	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="wrapper">
			<div class="site-branding">
				...
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><div class="mobi-logo" style="background-image: url(http://skeemteam.org/mbi/wp-content/uploads/2018/06/mobi2.png )"><i class= "icon-mobi"></i></div><?php bloginfo( 'name' ); ?></a></h1>
